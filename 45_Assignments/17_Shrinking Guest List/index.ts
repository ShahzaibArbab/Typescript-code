...
let Guests:string[]=["Abdul Basit","Abdul Bari","Abdul Haseeb"]
//Exercise 16
...
Guests.forEach(Guest =>{
    console.log(`Dear ${Guest} You're invited for the dinner..`)
})
...
while (Guests.length > 2){
    ...
    console.log(`Sorry Dear ${removeGuest}, I can't invite you to dinner.,`)
}
